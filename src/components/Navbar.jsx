...
export default function Navbar() {
  ...
  const headerBg = useTransparentHeader ? "transparent" : "rgba(255,255,255,1)";
            ...
            >
              <button
                style={{
                  ...
                  alignItems: "center",
                  gap: "4px",
                  borderBottom: pathname.startsWith("/schools")
                    ? "2px solid #0077e6"
