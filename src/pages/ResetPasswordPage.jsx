...
export default function ResetPasswordPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!res.ok) throw new Error(data?.error?.message || 'Password reset failed. Please try again.');
      setSuccess(true);
      let secs = 5;
      const interval = setInterval(() => {
        secs -= 1;
        setCountdown(secs);
        if (secs <= 0) { clearInterval(interval); navigate('/account'); }
      }, 1000);
    } catch (err) {
      ...
      <>
        ...
        <div className="rp-page">
          <div className="rp-simple-card">
            ...
            <h2 style={{ margin: '0 0 10px', color: '#1a1a2e', fontSize: 22, fontWeight: 800, fontFamily: "'Baloo 2', cursive" }}>
              Invalid Link
            </h2>
            <p style={{ color: '#64748b', fontSize: 14, lineHeight: 1.6, marginBottom: 24 }}>
              This password reset link is invalid or has expired. Please request a new one.
            </p>
            <Link to="/account" className="rp-btn-link">Back to Account</Link>
          </div>
        </div>
      </>
    );
      ...
      <>
        ...
        <div className="rp-page">
          <div className="rp-simple-card">
            ...
            <h2 style={{ margin: '0 0 10px', color: '#059669', fontSize: 22, fontWeight: 800, fontFamily: "'Baloo 2', cursive" }}>
              Password Updated!
            </h2>
            ...
            <Link to="/account" className="rp-btn-link">Sign in now →</Link>
          </div>
        </div>
      </>
    );
      ...
      <div className="rp-page">
        <div className="rp-card">
          ...
          <div className="rp-card-header">
            <h1 style={{ margin: 0, color: '#fff', fontSize: 22, fontWeight: 800, fontFamily: "'Baloo 2', cursive" }}>
              The Uniform Lab
            </h1>
          ...
          <div className="rp-card-body">
            <h2 style={{ margin: '0 0 6px', color: '#1a1a2e', fontSize: 20, fontWeight: 800, fontFamily: "'Baloo 2', cursive" }}>
              Create new password
            </h2>
                  ...
                  <div className="rp-strength-bar">
                    {[1, 2, 3, 4].map((lvl) => (
                      <div
                        ...
                        style={{ background: lvl <= strength ? strengthColors[strength - 1] : '#e2e8f0' }}
                      />
                    ))}
